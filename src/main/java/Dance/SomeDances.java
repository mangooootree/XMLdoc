 ...
 *       &lt;sequence>
 *         &lt;element name="UnitOfDance" type="{}Dance" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SomeDances")
public class SomeDances {

    @XmlElement(name = "UnitOfDance", required = true)
    protected List<Dance> unitOfDance;
     ...
     * {@link Dance }
     */
    public List<Dance> getUnitOfDance() {
        if (unitOfDance == null) {
            unitOfDance = new ArrayList<Dance>();
        }
